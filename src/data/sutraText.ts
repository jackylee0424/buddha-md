...
export const sutraPageContent = {
  'zh-Hant': {
    homeEyebrow: '金剛經原文',
    homeHeading: '鳩摩羅什譯《金剛經》全文',
    homeDescription: '收錄《金剛般若波羅蜜經》全文，並可透過語文切換閱讀繁體中文原文或英文譯文。',
    ctaLabel: '閱讀經文原文',
    pageEyebrow: '原典閱讀',
    pageTitle: '金剛經原文',
    pageDescription: '依鳩摩羅什譯本分章整理《金剛般若波羅蜜經》全文，目前顯示繁體中文原文；可切換至英文模式閱讀譯文。',
    introTitle: '經前偈與正文起首',
    introParagraphs: [
      "南無本師釋迦牟尼佛 南無般若會上佛菩薩",
      "開經偈",
    ...
    sourceLabel: '來源：Wikisource 鳩摩羅什譯《金剛般若波羅蜜經》與對應英文譯文',
    sourceUrl: 'https://zh.wikisource.org/zh-hant/金剛般若波羅蜜經_(鳩摩羅什)',
  },
  en: {
    homeEyebrow: 'The Diamond Sutra: full text',
    homeHeading: 'Read the Diamond Sutra in Chinese or English',
    homeDescription: 'Adds a dedicated full-text reading page for the Diamond Sutra, with language-mode switching between the Traditional Chinese text and the English translation.',
    ctaLabel: 'Read the sutra text',
    pageEyebrow: 'Sutra reading',
    pageTitle: 'The Diamond Sutra',
    pageDescription: 'Read the full Diamond Sutra in English; switch the language mode to view the Traditional Chinese text.',
    introTitle: 'Source note',
    introParagraphs: [
      "Taishō Tripiṭaka volume 8, number 235. Translated by Trepiṭaka Kumārajīva in 401 CE, as Jin’gang Bore Boluomi Jing (金剛般若波羅蜜經). This is the famous Diamond Sūtra, translated from the earliest known text.",
    ],
    sourceLabel: 'Source: Wikisource Chinese text and English translation',
    sourceUrl: 'https://en.wikisource.org/wiki/Translation:Vajracchedikā_Prajñāpāramitā_Sūtra',
  }
} as const;

export const sutraSections: SutraSection[] = [
  {
    id: 1,
    zhTitle: "法會因由分第一『說法聚會，由此起因』",
    zhParagraphs: [
      "如是我聞。 一時，佛在舍衛國祇樹給孤獨園，與大比丘眾千二百五十人俱。 爾時，世尊食時，著衣持缽，入舍衛大城乞食。 於其城中，次第乞已，還至本處。 飯食訖，收衣缽，洗足已，敷座而坐。",
    ],
    enTitle: "Section 1: The cause of the Dharma assembly",
    enParagraphs: [
  ...
  {
    id: 2,
    zhTitle: "善現啟請分第二『善現長老，啟請佛訓』",
    zhParagraphs: [
      "時，長老須菩提，在大眾中，即從座起，偏袒右肩，右膝著地，合掌恭敬。而白佛言： 「希有世尊！如來善護念諸菩薩，善付囑諸菩薩。 世尊！善男子、善女人，發阿耨多羅三藐三菩提心，應云何住？云何降伏其心？」",
      "佛言：「善哉，善哉。須菩提！ 如汝所說：如來善護念諸菩薩，善付囑諸菩薩。 汝今諦聽，當為汝說：善男子、善女人，發阿耨多羅三藐三菩提心，應如是住，如是降伏其心。」",
      "「唯然，世尊！願樂欲聞。」",
    ],
    enTitle: "Section 2: Elder Subhūti opens the question",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 3: The true way of the Great Vehicle",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 4: The wondrous practice of non-abiding",
    enParagraphs: [
  ...
  {
    id: 5,
    zhTitle: "如理實見分第五『自如之理，乃見真實』",
    zhParagraphs: [
      "「須菩提。於意云何？可以身相見如來不？」",
      "「不也，世尊，不可以身相得見如來。何以故？如來所說身相，即非身相。」",
      "佛告須菩提：「凡所有相，皆是虛妄。若見諸相非相，即見如來。」",
    ],
    enTitle: "Section 5: The principle for true perception",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 6: The rarity of true belief",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 9: The appearance without appearance",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 10: The adornment of pure lands",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 11: Unconditioned merits surpass all",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 13: Receiving and maintaining the Dharma",
    enParagraphs: [
  ...
  {
    id: 14,
    zhTitle: "離相寂滅分第十四『離諸形相，自得寂滅』",
    zhParagraphs: [
      "爾時，須菩提聞說是經，深解義趣，涕淚悲泣，而白佛言： 「希有世尊！佛說如是甚深經典，我從昔來所得慧眼，未曾得聞如是之經。 世尊！若復有人，得聞是經，信心清淨，則生實相，當知是人，成就第一希有功德。 世尊！是實相者，則是非相，是故如來說名實相。 世尊！我今得聞如是經典，信解受持，不足為難； 若當來世，後五百歲，其有眾生，得聞是經，信解受持，是人則為第一希有。 何以故？此人無我相、無人相、無眾生相、無壽者相。所以者何？ 我相，即是非相；人相、眾生相、壽者相，即是非相。何以故？ 離一切諸相，則名諸佛。」",
    ...
    enTitle: "Section 14: Leaving appearances: Nirvāṇa",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 15: The merits of maintaining this sūtra",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 16: Able to purify obstructions",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 17: Ultimately without self",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 18: Of a single unified perception",
    enParagraphs: [
  ...
  {
    id: 19,
    zhTitle: "法界通化分第十九『法身遍界，通化無邊』",
    zhParagraphs: [
      "「須菩提！於意云何？若有人滿三千大千世界七寶，以用布施，是人以是因緣，得福多不？」",
      "「如是，世尊！此人以是因緣，得福甚多。」",
      "「須菩提！若福德有實，如來不說得福德多；以福德無故，如來說得福德多。」",
    ],
    enTitle: "Section 19: Pervading the Dharma Realm",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 20: Leaving form, leaving appearance",
    enParagraphs: [
  ...
  {
    id: 21,
    zhTitle: "非說所說分第二十一『法無可說，所說非法』",
    zhParagraphs: [
      "「須菩提！汝勿謂如來作是念：『我當有所說法。』莫作是念。何以故？ 若人言：如來有所說法，即為謗佛，不能解我所說故。 須菩提！說法者，無法可說，是名說法。」",
      "爾時，慧命須菩提白佛言：「世尊！頗有眾生，於未來世，聞說是法，生信心不？」",
      "佛言：「須菩提！彼非眾生，非不眾生。何以故？ 須菩提！眾生眾生者，如來說非眾生，是名眾生。」",
    ],
    enTitle: "Section 21: No speaking, no dharma to speak",
    enParagraphs: [
  ...
  {
    id: 22,
    zhTitle: "無法可得分第二十二『悟性空故，無法可得』",
    zhParagraphs: [
      "須菩提白佛言：「世尊！佛得阿耨多羅三藐三菩提。為無所得耶？」",
      "佛言：「如是，如是。須菩提！我於阿耨多羅三藐三菩提乃至無有少法可得， 是名阿耨多羅三藐三菩提。」",
    ],
    enTitle: "Section 22: No dharmas may be grasped",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 26: The Dharmakāya is without appearance",
    enParagraphs: [
      ...
      "Whoever sees me in form, whoever seeks me in sound, is practicing a deviant path and cannot perceive the Tathāgata.",
    ]
  },
  {
    id: 27,
    zhTitle: "無斷無滅分第二十七『依法修持，不應斷滅』",
    zhParagraphs: [
      "「須菩提！汝若作是念：『如來不以具足相故，得阿耨多羅三藐三菩提。』 須菩提！莫作是念：『如來不以具足相故，得阿耨多羅三藐三菩提。』」",
      "「須菩提！汝若作是念，發阿耨多羅三藐三菩提心者，說諸法斷滅。莫作是念！何以故？ 發阿耨多羅三藐三菩提心者。於法不說斷滅相。」",
    ],
    enTitle: "Section 27: No severing, no annihilation",
    enParagraphs: [
  ...
  {
    id: 28,
    zhTitle: "不受不貪分第二十八『一塵不染，何貪何受』",
    zhParagraphs: [
      "「須菩提！若菩薩以滿恆河沙等世界七寶持用布施； 若復有人，知一切法無我，得成於忍，此菩薩勝前菩薩所得功德。何以故？ 須菩提！以諸菩薩不受福德故。」",
      "須菩提白佛言：「世尊！云何菩薩不受福德？」",
      "「須菩提！菩薩所作福德，不應貪著。是故說不受福德。」",
    ],
    enTitle: "Section 28: Not receiving, not desiring",
    enParagraphs: [
  ...
  {
    id: 29,
    zhTitle: "威儀寂靜分第二十九『真性寂靜，不假威儀』",
    zhParagraphs: [
      "「須菩提！若有人言：如來若來若去，若坐若臥，是人不解我所說義。 何以故？如來者，無所從來，亦無所去，故名如來。」",
    ],
    enTitle: "Section 29: Power and position destroyed in silence",
    enParagraphs: [
  ...
  },
  {
    ...
    enTitle: "Section 30: The principle of the unity of appearances",
    enParagraphs: [
